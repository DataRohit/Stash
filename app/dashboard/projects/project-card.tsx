...
export function ProjectCard({
  ...
  return (
    <article className="relative min-w-0">
      <FavoriteButton projectId={id} favorite={favorite} className="absolute top-2 right-2 z-10" />
      <Link
      ...
      >
        <div className="flex items-start gap-4">
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-1">
            <p className="flex items-center gap-2 truncate pr-8 font-serif text-xl tracking-display">
