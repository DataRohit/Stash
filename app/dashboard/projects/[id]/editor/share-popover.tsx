...
export function SharePopover({ state, origin, onSetMode, onCopy }: SharePopoverProps) {
  ...
  return (
    <div className="absolute top-10 right-0 z-[85] w-[min(24rem,calc(100vw-2rem))] overflow-hidden rounded-lg border border-hairline bg-surface p-1 shadow-xl">
