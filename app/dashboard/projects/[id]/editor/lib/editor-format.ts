const DOC_ERROR_MESSAGES: ReadonlyArray<readonly [string, string]> = [
  ...
  ["invalid-update", "That edit could not be read. Your local changes remain queued."],
  ...
  ["file-too-large", "This file is too large (max 512 KB per file)."],
  ...
  ["invalid-type", "Files must use a supported document type."],
